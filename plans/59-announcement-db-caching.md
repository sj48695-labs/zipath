...
### Phase 1 (완료): 엔티티 확장 — fetchedAt + externalId + UNIQUE
...
### Phase 2 (완료): 서비스 upsert 전환 + fetchedAt 세팅
...
### Phase 3 (완료): cleanup 3개월 fetchedAt 정책 추가
...
### Phase 4 (완료): AnnouncementService 유닛 테스트
